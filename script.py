...
os.system("rm -r -f internal/templayer.mp3")
os.system("$HOME/.local/bin/gtts-cli --lang en --file text.txt -o internal/temp1.mp3 > /dev/null 2>&1")
lines = open('text.txt').readlines()
random.shuffle(lines)
open('text.txt', 'w').writelines(lines)
speed = input("Choose speed: normal, 2, 4, 8, or 16: ")
sys.stdout = open(os.devnull, 'w')
os.system("$HOME/.local/bin/gtts-cli --lang en --file text.txt -o internal/templayer.mp3 > /dev/null 2>&1")
...
os.system ("(cd prerequisites/audacity/build/ && DISPLAY=:99 ./audacity) > /dev/null 2>&1 & disown audacity > /dev/null 2>&1")
time.sleep(20)
